  ...
  return (
    <Protected>
      ...
      <div className="w-40 ml-6">
        ...
        <select className="mt-2 block border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full">
          <option value="all" onClick={() => AllProducts()}>
            All Products
          </option>
          <option
            value="men-clothing"
          ...
          <option value="camera" onClick={() => filterproduct("Camera")}>
            Camera
          </option>
          <option value="gaming" onClick={() => filterproduct("Gaming")}>
            Gaming
          </option>
        </select>
      </div>
